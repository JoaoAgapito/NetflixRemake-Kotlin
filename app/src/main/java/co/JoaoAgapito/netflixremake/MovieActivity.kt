...
class MovieActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val rv: RecyclerView = findViewById(R.id.movie_rv_similares)

        txtTitle.text = "Batman Begins"
        txtDesc.text = "Essa é a descrição do filme do Batman e bla bla bla bla"
        txtCast.text = getString(R.string.cast, "Ator A, Ator B, Atriz C e por ai vai")
